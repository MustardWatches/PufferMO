...
int demo() {
    ...
    env.client = make_client_mo(2, env.width, env.height);
...
void test_performance(float test_time) {
    CSnakeMO env = {
        ...
        .vision = 5,
        .leave_corpse_on_death = true,
        .reward_food_value = 0.1f,
        .reward_corpse_value = 0.1f,
        .reward_death_value = -1.0f,
        .gamma = 0.9997f,
    };
    allocate_csnake_mo(&env);
    c_reset_mo(&env);
